...
export default function VehiclePayments({ siteId, bill, onBack, onProceedToSeedStocking, onProceedToPacking, onProceedToMixed, onProceedClicked, loadBills, updateBill }) {
  const { user } = useAuth();
