...
/**
 * HarvestChecklist — 9 mandatory pre-harvest checks before weighing.
 * Prevents unauthorized or unsafe harvests.
 */
export default function HarvestChecklist({ checklist, setChecklist, onProceed, onBack }) {
  const items = [
      ...
      >
        <div>
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
            All 9 safety and operational items must be verified before proceeding to weighment.
          </p>
        </div>
